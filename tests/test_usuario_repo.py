...
class TestUsuarioRepo:
    ...
    def test_get_by_id(self, test_db):
        ...
        usuario_db = repo_usuario.get_by_id(id_usuario)
        # Assert
        assert usuario_db is not None, "Usuário não deveria ser None ao buscar por ID"
        assert usuario_db.id == id_usuario, "ID do usuário buscado deveria ser igual ao ID inserido"
        assert usuario_db.nome == "Usuário Teste", "Nome do usuário deveria ser 'Usuário Teste'"
        assert usuario_db.id_cidade.id == id_cidade, "ID da cidade do usuário deveria ser igual ao inserido"
        assert usuario_db.id_cidade.nome == "Test Cidade", "Nome da cidade do usuário deveria ser 'Test Cidade'"
        assert usuario_db.id_cidade.id_uf.id == id_uf_inserida, "ID da UF da cidade deveria ser igual ao inserido"
        assert usuario_db.id_cidade.id_uf.nome == "Test UF", "Nome da UF da cidade deveria ser 'Test UF'"
